...
<div id="openPage" style="width:99%;height:100%;background-color:rgb(255,255,255);position:absolute;top: 0;display:flex;overflow:hidden">
	...
	<div class="tabDiv" id="codeDiv" style="overflow:hidden">
	...
	<div id="chooseCoins" style="margin-left:20px;display:none;">
